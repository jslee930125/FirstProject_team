    	...
    	<div class="container">
	        ...
	        <div class="text-center p-0 mt-3 mb-2">
	            <div class="card px-0 pt-4 pb-0">
	                <h2 id="heading">샐러드에 들어갈 해산물을 선택해주세요!</h2>
	                ...
	                <form id="msform">
	                    ...
	                    <ul id="progressbar">
	                        ...
	                        <li class="active" id="step3"><strong>Step3</strong></li>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="shoping__cart__btns">
                        <a href="#" class="primary-btn cart-btn" onclick="location.href='/R_Custom/step2'">Previous</a>
                        <a href="#" class="primary-btn cart-btn cart-btn-right"  value="다음" onclick="location.href='/R_Custom/step4'">
                        	Next
                        </a>                   
                    </div>
                </div>
