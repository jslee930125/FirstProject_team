    	...
    	<div class="container">
	        ...
	        <div class="text-center p-0 mt-3 mb-2">
	            <div class="card px-0 pt-4 pb-0">
	                <h2 id="heading">샐러드에 들어갈 기타 재료를 선택해주세요!</h2>
	                ...
	                <form id="msform">
	                    ...
	                    <ul id="progressbar">
	                        ...
	                        <li class="active" id="step5"><strong>Step5</strong></li>
	                    </ul>
	                    <div class="progress">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="shoping__cart__btns">
                        <a href="#" class="primary-btn cart-btn" onclick="location.href='/R_Custom/step4'">Previous</a>           
                        <a id="btn-2" class="primary-btn cart-btn cart-btn-right" onclick="">
                        	Submit
                        </a>      
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="checkout__order">
						...
						<form role="form">
							<button type="submit" id="btn-1" class="recipe_btn" >레시피 등록</button>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#btn-1").on("click",function(){
				fr.attr("action","/R_Custom/addRecipe")
				fr.attr("method","get");
				fr.submit();
			});
			...
			$("#btn-2").on("click",function(){
				fr.attr("action","/R_Custom/addCart")
				fr.attr("method","get");
				fr.submit();
			});
		});
