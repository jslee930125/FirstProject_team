...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="/index"><img src="/resources/saladmall/img/logo.png" alt=""></a>
        </div>
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
				...
				<li><a href="/R_Custom/main">Order</a></li>
				<li><a href="/R_Board/boardList">Recipe</a></li>
				<li><a href="/CS/listAll">Notice&#47;Event</a></li>
            </ul>
        </nav>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                            	<c:if test="${m_id == null }">
                                <a href="/M_Login/login"><i class="fa fa-user"></i> Login</a>
                                </c:if>
                                <c:if test="${m_id != null }">
                                <a href="/M_Login/logout"><i class="fa fa-user"></i> Logout</a>
                            	</c:if>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="/CS/listAll">Notice&#47;Event</a></li>
                            <c:if test="${m_id != null }">
                            <li><a href="/M_Main/mypage">MyPage</a></li>
                            </c:if>
                        </ul>
                    </nav>
                </div>
