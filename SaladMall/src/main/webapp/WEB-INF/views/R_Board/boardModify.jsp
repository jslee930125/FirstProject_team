            ...
            <form id="modify_form" action="" method="post">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <input readonly id="rcp_name" name="rcp_name" type="text" placeholder="샐러드 선택" value="${board.recipe.rcp_name }">
                    </div>
                    <div class="col-lg-12 col-md-12">
                    	<ul id="rcp_search">
                    	</ul>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <input id="rcp_b_title" name="rcp_b_title" type="text" placeholder="제목" value="${board.board.rcp_b_title }">
                    </div>
                    <br>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <textarea id="rcp_b_content" name="rcp_b_content" placeholder="리뷰 내용">${board.board.rcp_b_content }</textarea>
                    </div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#modify_btn").click(function(){
				...
				$("#modify_form").attr("action", "./boardModify");
				$("#modify_form").submit();
			});
		});
	</script>