                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <img src="/resources/admin/dist/img/chunsik.jpg" class="img-circle" alt="User Image"/>
                          </div>
                          <h4>
                            Support Team
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="/resources/admin/dist/img/apeach.jpg" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                            Design Team
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="/M_Login/logout" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
            ...
            <li class="header">MAIN NAVIGATION</li>
	            <li class="treeview">
	              ...
	              <ul class="treeview-menu">
	                <li><a href="./mListAll"><i class="fa fa-circle-o"></i> 고객 정보 </a></li>
	                <li><a href="./oListAll"><i class="fa fa-circle-o"></i> 주문 정보 </a></li>
	            </ul>
	            </li>
	             <li class="treeview">
	              <a href="#">
	              ...
	              <ul class="treeview-menu">
	                <li><a href="./igdtListAll"><i class="fa fa-circle-o"></i> 재료 재고 정보 </a></li>
	                <li><a href="./igdtRegister"><i class="fa fa-circle-o"></i> 샐러드 재료 등록 </a></li>
	            </ul>
	            </li>
	            <li class="treeview">
	              <a href="#">
	              ...
	              <ul class="treeview-menu">
	                <li><a href="./couponListAll"><i class="fa fa-circle-o"></i> 쿠폰 정보 </a></li>
	              </ul>
	            </li>
	            <li class="treeview">
	              <a href="#">
