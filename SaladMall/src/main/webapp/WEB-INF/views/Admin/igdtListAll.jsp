									...
									<thead>
										<tr role="row">
											<th class="sorting_asc" tabindex="0" aria-controls="example2"
												...
												aria-label="Rendering engine: activate to sort column descending">재료번호</th>
											<th class="sorting" tabindex="0" aria-controls="example2"
												rowspan="1" colspan="1"
												aria-label="Browser: activate to sort column ascending">재료 카테고리</th>
											<th class="sorting" tabindex="0" aria-controls="example2"
												rowspan="1" colspan="1"
												aria-label="Platform(s): activate to sort column ascending">재료 이름</th>
											<th class="sorting" tabindex="0" aria-controls="example2"
												rowspan="1" colspan="1"
												aria-label="Platform(s): activate to sort column ascending">재료 가격</th>	
											<th class="sorting" tabindex="0" aria-controls="example2"
												rowspan="1" colspan="1"
												aria-label="Platform(s): activate to sort column ascending">원산지</th>
											<th class="sorting" tabindex="0" aria-controls="example2"
												rowspan="1" colspan="1"
												aria-label="CSS grade: activate to sort column ascending">재고 수량</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach var="ivo" items="${igdtListAll }">
											<tr role="row" class="odd">
												<td class="sorting_1"><a href="/Admin/igdtInfo?igdt_num=${ivo.igdt_num }&pageNum=${pm.cri.pageNum}">${ivo.igdt_num }</a></td>
												<c:choose>
