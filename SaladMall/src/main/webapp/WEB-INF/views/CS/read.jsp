...
<section class="breadcrumb-section set-bg" data-setbg="${pageContext.request.contextPath}/resources/saladmall/img/breadcrumb.jpg">
	<div class="container">
		<div class="row">
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="form-group col-sm-2">
						<input class="form-control input-sm" id="new_reply_m_id" type="text" value="${m_id }" readonly="readonly">
					</div>
					<div class="form-group col-sm-2">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#CSB_btn_list").click(function() {
			location.href = "/CS/listAll?pageNum=${pageNum }";
		});
	});
