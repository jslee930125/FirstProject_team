				...
				<div class="shoping__cart__table">
					<form action="" method="post">
							...
							<tbody>
								<c:forEach var="vo" items="${Basket}">
									<form action="" method="post">
										...
										<input type="hidden" name="cart_amount" value="${vo.cart_amount }"> <input type="hidden" name="cart_price" value="${vo.cart_price }">
						...
						<div class="text-center">
							<button class="bkpayment_btn site-btn_green"  type="button" onclick="location.href='/Payment/cart'">주문하기</button>
						</div>
					</form>
				</div>
			</div>
